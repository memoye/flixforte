            ...
            <section className='md:flex gap-10 pt-4 md:border-b border-skin-muted md:py-8'>
                <div className='md:self-center h-full grid items-center gap-8'>
                    <div className='md:text-start text-center'>
                        <h1 className='md:text-5xl text-4xl font-semibold md:leading-snug leading-snug
 md:w-10/12'><span className='bg-gradient-to-r from-red-500 via-lime-500 to-blue-500 bg-[length:100%_6px] bg-no-repeat bg-bottom cursor-none font-bold text-skin-muted text-opacity-90'>Unleash</span> your inner movie buff!</h1>
